...
import static com.lzdn.common.util.StringUtil.lineToHump;
...
public class MybatisGeneratorUtil {
	...
	public static void generator(
		...
		String serviceImplPath = basePath + module + "/src/main/java/" + packageName.replaceAll("\\.", "/") + "/service";
        ...
        for (int i = 0; i < tables.size(); i++) {
			...
			String serviceMock = servicePath + "/serviceMock/" + model + "ServiceMock.java";
			String serviceImpl = serviceImplPath + "/serviceImpl/" + model + "ServiceImpl.java";
			// 生成service
