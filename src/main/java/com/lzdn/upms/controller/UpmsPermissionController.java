...
public class UpmsPermissionController extends BaseController {
    ...
    public String permissionView(ModelMap modelMap){
        return "upms/permission/index.jsp";
    }
    ...
    public Object permissionList(
            ...
            @RequestParam(required = false,defaultValue = "permission_id",value = "sort")String sort,
        ...
        List<UpmsPermission> rows = upmsPermissionService
                .selectByExampleForOffsetPage(upmsPermissionExample,offset,limit);
    ...
    public String createView(ModelMap modelMap){
        ...
        return "upms/permission/create.jsp";
    }
    ...
    public String updateView(@PathVariable("id") int id, ModelMap modelMap) {
        ...
        modelMap.put("upmsSystems", upmsSystems);
        return "/upms/permission/update.jsp";
    }
    @ApiOperation(value = "修改权限")
    @RequiresPermissions("upms:permission:update")
