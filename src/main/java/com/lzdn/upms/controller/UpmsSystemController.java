...
public class UpmsSystemController extends BaseController {
    ...
    public Object list(
            ...
            @RequestParam(required = false,defaultValue = "system_id",value = "sort")String sort,
