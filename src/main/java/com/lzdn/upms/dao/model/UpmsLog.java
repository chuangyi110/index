...
public class UpmsLog implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getLogId() == null ? other.getLogId() == null : this.getLogId().equals(other.getLogId()))
            && (this.getDescripion() == null ? other.getDescripion() == null : this.getDescripion().equals(other.getDescripion()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getDescripion() == null) ? 0 : getDescripion().hashCode());
