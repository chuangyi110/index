...
<head>
	...
	<link href="${basePath}/static/upms/plugins/bootstrap-3.3.0/css/bootstrap.min.css" rel="stylesheet"/>
	<link href="${basePath}/static/upms/plugins/material-design-iconic-font-2.2.0/css/material-design-iconic-font.min.css" rel="stylesheet"/>
	<link href="${basePath}/static/upms/plugins/waves-0.7.5/waves.min.css" rel="stylesheet"/>
	<link href="${basePath}/static/upms/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css" rel="stylesheet"/>
	<link href="${basePath}/static/upms/css/admin.css" rel="stylesheet"/>
	<style>
		/** skins **/
	...
	<ul id="menu">
		...
		<li id="logo" class="hidden-xs">
			<a href="${basePath}/manage/index">
				<img src="${basePath}/static/upms/images/logo.png"/>
			</a>
			...
			<ul class="hi-menu">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu dm-icon pull-right">
						...
						<li>
							<a class="waves-effect" href="${basePath}/sys/logout"><i class="zmdi zmdi-run"></i> 退出登录</a>
						</li>
					</ul>
				</li>
			</ul>
	...
	<aside id="sidebar">
		...
		<div class="s-profile">
			...
			<ul class="main-menu">
				...
				<li>
					<a class="waves-effect" href="/sys/logout"><i class="zmdi zmdi-run"></i> 退出登录</a>
				</li>
			</ul>
		</div>
		<!-- /个人资料区 -->
...
<script src="${basePath}/static/upms/plugins/jquery.1.12.4.min.js"></script>
<script src="${basePath}/static/upms/plugins/bootstrap-3.3.0/js/bootstrap.min.js"></script>
<script src="${basePath}/static/upms/plugins/waves-0.7.5/waves.min.js"></script>
<script src="${basePath}/static/upms/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js"></script>
<script src="${basePath}/static/upms/plugins/BootstrapMenu.min.js"></script>
<script src="${basePath}/static/upms/plugins/device.min.js"></script>
<script src="${basePath}/static/upms/plugins/jquery.cookie.js"></script>
<script src="${basePath}/static/upms/js/admin.js"></script>
<script src="${basePath}/static/upms/plugins/fullPage/jquery.fullPage.min.js"></script>
<script src="${basePath}/static/upms/plugins/fullPage/jquery.jdirk.min.js"></script>
</body>
</html>