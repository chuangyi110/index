...
function initPid(val) {
	if (systemId != 0) {
		$.getJSON('${basePath}/upms/permission/list', {systemId: systemId, type: pidType, limit: 10000}, function(json) {
...
function updateSubmit() {
    $.ajax({
        type: 'post',
        url: '${basePath}/upms/permission/update/${permission.permissionId}',
