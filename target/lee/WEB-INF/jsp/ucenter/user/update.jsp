	...
	<form id="updateForm" method="post">
		...
		<div class="row">
			<div class="col-lg-8 form-group">
				...
				<input id="avatar" type="text" class="form-control" name="avatar" maxlength="150" value="${ucenterUser.avatar}">
			</div>
			<div class="col-lg-4">
		...
		<div class="form-group">
			...
			<input id="email" type="text" class="form-control" name="email" maxlength="50" value="${ucenterUser.email}">
		</div>
		<div class="radio">
			<div class="radio radio-inline radio-info">
				<input id="sex_0" type="radio" name="sex" value="0" <c:if test="${ucenterUser.sex==0}">checked</c:if>>
				<label for="sex_0">男</label>
			</div>
			<div class="radio radio-inline radio-danger">
				<input id="sex_1" type="radio" name="sex" value="1" <c:if test="${ucenterUser.sex==1}">checked</c:if>>
...
function createSubmit() {
    $.ajax({
        type: 'post',
        url: '${basePath}/ucenter/user/update/${ucenterUser.userId}',
