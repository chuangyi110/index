...
<div id="createDialog" class="crudDialog">
	<form id="createForm" method="post">
		...
		<div class="form-group">
			...
			<input id="typeName" type="text" class="form-control" name="typeName" maxlength="20">
		</div>
	...
	$.ajax({
		...
		success:function(result) {
            ...
            for (var i = 0; i < result.rows.length; i ++) {
                ...
                data.text = result.rows[i].typeName;
                datas.push(data);
            }
...
function createSubmit() {
    ...
    $.ajax({
        type: 'post',
        url: '${basePath}/ucenter/companyType/create',
        data: {pid:pid,typeName:$("#typeName").val()},
        beforeSend: function() {
            if ($('#typeName').val() == '') {
                $('#typeName').focus();
                return false;
