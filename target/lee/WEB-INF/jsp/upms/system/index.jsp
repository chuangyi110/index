...
function createAction() {
	createDialog = $.dialog({
		animationSpeed: 300,
		title: '新增系统',
		content: 'url:${basePath}/upms/system/create',
...
function updateAction() {
	...
	if (rows.length != 1) {
		...
		updateDialog = $.dialog({
			animationSpeed: 300,
			title: '编辑系统',
			content: 'url:${basePath}/upms/system/update/' + rows[0].systemId,
			onContentReady: function () {
				initMaterialInput();
				initUploader();
			}
			...
			buttons: {
				confirm: {
					...
					action: function () {
						...
						$.ajax({
							type: 'get',
							url: '${basePath}/upms/system/delete/' + ids.join("-"),
